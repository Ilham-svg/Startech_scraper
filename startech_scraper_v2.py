...
# IMPORTANT: Do NOT include "br" in Accept-Encoding. The server sends Brotli
...
HEADERS = {
    ...
    "Accept-Encoding": "gzip, deflate",   # <-- "br" removed (fixes Brotli issue)
    ...
    for idx, url in enumerate(urls, start=1):
        ...
        try:
            ...
            if not row["Specification HTML"] and not row["Description HTML"]:
                ...
                row["Status"] = "success"
                row["Error Message"] = ""
                print(f"    OK  | Title: {row['Product Name'][:60]}...")
